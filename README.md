# The Freedom Guide: Learn and Master the Art of Entrepreneurship
Picture this. You open Instagram or TikTok, scroll for a few (maybe not so "few"...) minutes, and see countless videos of people producing content around their successful businesses. You do not even know whether those people actually have all that success behind the wonderful frame of social media, but you are now eager: you will start your own business and change your life, no matter what. Wonderful! But... how do you even start? The truth about entrepreneurship is that most individuals simply have no idea what it even means to start a business, let alone how to actually manage one with efficiency. The result of this situation is clear: 61% of Americans have had an idea for starting a business, but a whopping 92% of those never turn such aspirations into reality (Harris Poll, 2021). However, that should not be so surprising! The detail that most gurus do not tell you is that starting any serious business involves a comprehensive (and often overwhelming) set of knowledge that allows you to create value and operate optimally throughout the entire journey. 

Well, here's where this guide comes into play. `The Freedom Guide: Learn and Master the Art of Entrepreneurship` is a complete roadmap that will provide all the learning resources you need to start your own business. After going through the proposed resources, you will have all the necessary knowledge to effectively create value through your venture and, hopefully, change your life. Having that said, let's make some money 💵.

## Table of Contents
Before anything else, the table of contents below is a quick way to navigate to any section of this guide:
...
First of all, let's understand how this guide works. It contains several learning resources (which contain books, videos/talks, slides, articles, and more) for many relevant topics within entrepreneurship, regardless of which specific industry you are in. More specifically, there are two main learning sections in this roadmap:
- `Generic Resources`: This section contains resources such as books and articles that address entrepreneurship as a whole and intend to provide a more general foundation for further learning and practice. Moreover, you'll find the most important first step of this entire guide: the Entrepreneurship Specialization group of courses, by the University of Pennsylvania. These courses address the main concepts involved in the conception, design, organization, and management of new enterprises, and will be a relevant foundation that will allow you to be exposed to more advanced and/or specific topics within the field.
  - Some courses/platforms may charge money for assignments and tests (for access or grading). While Coursera falls into this category for parts of its course catalog, it offers financial aid and options for a free audit of courses (what, practice, will give you access to its content). Having that said, the contents are still freely accessible, and you can decide whether you want to pay some money for extra resources (like graded tests or certificates).
  - We mentioned that you can freely audit Coursera's courses and get access to its content for free, even though not extra materials such as graded assignments. For many of their courses, however, there is a workaround:
    -  [Audit the Coursera course](https://www.classcentral.com/report/coursera-signup-for-free/). Now you have access to content.
- `Topics`: This part of the guide contains learning resources chosen specifically for localized topics. 

Learning with efficiency is not easy, and it is relevant to get some advice on possible ways to make your journey better while using this guide:
- `Do not rush`. Entrepreneurship has countless complex nuances, and sometimes you will not get them well on the first try. Take your time, practice the concepts, and make sure you are at the point of almost knowing what you are doing before moving on
- `Start as soon as possible, but be rational`. There is nothing more important when it comes to starting your own business than... actually doing it! My suggestion is that you do not wait until finishing all the content in this guide to begin your entrepreneurial activities, but instead start as soon as you have the foundation to do so (for instance, after watching the Entrepreneurship Specialization by UPenn and reading some articles/books). Nevertheless, pay attention and assess whether you actually have the foundations; it is only reasonable to do parachute jumping if you have information about the weather, knowledge of procedures, and possess equipment!
- `Do not lose yourself in your goals`. Starting your own business is one of the most exciting experiences you can have, but your feelings for it can change with equal intensity. Many people figure out after some trial and experience that having a business is not what they really want, or that it is not the moment for such adventure yet. There is no shame in that, and the knowledge you gain here will easily transfer to other areas. However, if this is not your case, don't give up your dreams when things get hard; stay focused and work hard because better times are to come.
- `Stay tuned for additions and improvements to this guide`. This is a dynamic roadmap and will change over time via additions and improvements made to this repository. If you do not want to miss those, I recommend saving the link to this repository and following Entropic Group's social media platforms (see [networking](#networking)) to know when new interesting stuff is being added.
 
# Networking

If you are still reading this, chances are you're interested in our work... and there is good news: there is much, much more. First of all let me explain what we, the "Entropic Group", are all about. We are a group that brings together entrepreneurs, programmers, and professionals of all kinds who seek self-development and networking. Networking... keep that word in mind, as it represents one of the most important assets for entrepreneurs and professionals of all kinds. It allows you to build a supportive web of connections and gather different sets of skills in a way that no individual, even geniuses, could ever do. Indeed, it can be the difference between failure and success. Don't believe me? You do not need to! Take a look at the biographies of some of the biggest businessmen out there and look for moments where their vast list of connections allowed them to be where they are today; I assure you will find them.

Nevertheless, networking can be hard, and we're again here to help. Through our Discord server (which is totally free to access!), members can:
...
`Hot advice`: If you want to learn along with other people, ask questions, get any other kind of help, or make suggestions regarding this roadmap, the Discord server linked above is your best option! You can use our dedicated chatrooms or ask questions directly to members (including the moderators). Moreover, if you are looking for people to collaborate on a new business idea, or offer services to your business, our Discord server can be handy. As we like to say in our community, let's `grow like entropy`!

## Generic resources

### Foundation
As mentioned in the introduction, we begin with this specialization by the University of Pennsylvania, which covers the most important concepts involved in starting your own business:
- [Entrepreneurship Specialization](https://www.coursera.org/specializations/wharton-entrepreneurship)
<br>
Moreover, do not forget to refer to the tip given in the introduction on how to get access to the course contents for free!

### Books and playbooks
Every major topic like entrepreneurship has some "must-reads" that provide you with the most valuable insights gathered over the years, from the best professionals in the field. Fair enough, this roadmap compiles some good choices for you:
...
### Articles
There is a lot of wisdom scattered over the internet that takes the form of articles. The same is true when it comes to starting a business, so you might want to take a look at those:
...
## Topics
At this point of the roadmap, you have a solid foundation in all the main concepts that concern entrepreneurship and its complexities. Therefore, you are ready to get more knowledge and experience in specific areas, and this is what this section is all about. For each of the topics listed (it might be useful to refer to the table of contents, from the beginning, to get a more global view), learning resources are linked to help you develop your expertise in that area. Furthermore, it is now really up to you to decide what contents to use, in what order, and for which topics you might want to add external items to the list. In that sense, it can be useful to use self-reflection and honestly work around your own strengths and weaknesses related to business.
### Acquisition
...
- [Data-driven decision making](https://www.coursera.org/learn/decision-making) and [reporting academy](https://www2.deloitte.com/us/en/pages/human-capital/solutions/data-driven-decision-making-program.html): Businesses that do not use data in their favor are necessarily leaving gains in the table. Do not be one of those.
...
- [What does it mean to be detail-oriented?](https://www.forbes.com/sites/chriswestfall/2023/09/25/what-it-means-to-be-detail-oriented-7-signs-that-this-is-you/)
- [How to make your work more detail oriented](https://www.indeed.com/career-advice/career-development/become-detail-oriented)
...
- [How to split equity among co-founders](https://www.ycombinator.com/library/5x-how-to-split-equity-among-co-founders)

### Competition

- [The Real Competition is the Water](https://www.rkg.blog/water.php)
- [Learn how to analyse your competitors](https://www.coursera.org/learn/businessintelligence)
...
- [Learn decision making and problem solving](https://www.coursera.org/learn/problem-solving)
...
- [What are the types of innovations and what to learn from each one?](https://hbr.org/2017/06/the-4-types-of-innovation-and-the-problems-they-solve)
...
- [Ethics for business professionals](https://openstax.org/details/books/business-ethics/)
- [Useful definitions and ideas](https://www.investopedia.com/terms/b/business-ethics.asp)
...
- [Learn the fundamentals of finance](https://www.youtube.com/watch?v=EJHPltmAULA&ab_channel=freeCodeCamp.org)
- [Learn accounting](https://www.youtube.com/watch?v=v-djL7SPw4c)
...
- [How can you get the money to start your business?](https://www.youtube.com/watch?v=MYVL1XHeB74&pp=ygUQZnVuZGluZyBidXNpbmVzcw%3D%3D)
...
- [Learn how to hire and get the best people](https://www.youtube.com/watch?v=sxjgL64czRY&pp=ygULaG93IHRvIGhpcmU%3D)
...
- [A quick intro to investor relations](https://www.youtube.com/watch?v=Y0MfPNSOhN8&pp=ygUSaW52ZXN0b3IgcmVsYXRpb25z)
...
This is also useful for this roadmap; that's amazing!
...
- [Mental models from a marketing psychology perspective](https://blog.hubspot.com/marketing/mental-models)
...
- [How to pivot successfully](https://www.forbes.com/councils/theyec/2020/07/03/how-to-pivot-successfully-in-business/)
...
- [Make better decisions under uncertainties](https://executiveeducation.wharton.upenn.edu/thought-leadership/wharton-at-work/2016/02/better-decisions-under-uncertainty/)
...
- [Learn how to plan and manage efficient processes](https://www.coursera.org/learn/illinois-tech-operations-process-management)
...
- [Master the art of product design](https://www.udacity.com/course/product-design--ud509)
...
- [Marketing strategy](https://www.coursera.org/specializations/marketing-strategy)
...
- [Learn how to lead people and teams](https://www.coursera.org/specializations/leading-teams)
...
- [How to make your project management Agile?](https://business.adobe.com/blog/basics/agile)
...
- [How to deal with customers in difficult situations](https://www.indeed.com/career-advice/career-development/how-to-deal-with-difficult-customers)
...
- [Empower the best software solutions for your business](https://www.doola.com/blog/best-software-for-entrepreneurs/)
...
- [Learn copywriting in 4 hours](https://www.youtube.com/watch?v=aOSGrr_LNQk)
...
# Your next steps
If you arrived up to here, congratulations! You now have a good amount of knowledge to run your own business rationally and make informed decisions; from now on, experience will teach you the rest. If you already started working on your venture, keep going and remember to apply the knowledge acquired here to maximize your results. If you still want to become an entrepreneur but have not begun, this might be the best time to do so; create your brand, define your business model, build MVPs, and validate them.
If this guide was helpful, do not forget to check out our Discord server and Instagram pages for more helpful content, and share this with a friend you want to have success with. `Let's grow like entropy`.
